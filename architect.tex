...
\begin{figure}[htb]
  \centering
  %% \begin{subfigure} {\includegraphics[width= \textwidth]{grid.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width= .4\textwidth]{grid.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width= .4\textwidth]{random.png}} \end{subfigure}
  %% \begin{subfigure} {\includegraphics[width=.3\textwidth]{small_world.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
  \caption{topologies}
\end{figure}
...
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{latency_benchmark.png}} \end{subfigure}
%%   \rule{\linewidth}{1pt}
%%   \caption{latency}
...
%%   \rule{\linewidth}{1pt}
%%   \caption{energy}
%%   \label{fig:energy_normalized_benchmark}
%% \end{figure}
...
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{path_length_average_benchmark.png}} \end{subfigure}
%%   \rule{\linewidth}{1pt}
...
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{hop_count_average_benchmark}} \end{subfigure}
%%   \rule{\linewidth}{1pt}
...
%% \begin{figure}[htb]
%%   \centering
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{link_lengths_canneal.png}} \end{subfigure}
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{link_lengths_dedup.png}} \end{subfigure}
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{link_lengths_fft.png}} \end{subfigure}
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{link_lengths_fluidanimate.png}} \end{subfigure}
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{link_lengths_lu.png}} \end{subfigure}
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{link_lengths_radix.png}} \end{subfigure}
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{link_lengths_vips.png}} \end{subfigure}
%%   \begin{subfigure} {\includegraphics[width=.4\textwidth]{link_lengths_water.png}} \end{subfigure}
%%   \rule{\linewidth}{1pt}
%%   \caption{link length distribution}
