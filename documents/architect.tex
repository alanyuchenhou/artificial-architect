...
%%     \centering
%%     \begin{subfigure}
%%       {\includegraphics[width=\textwidth]{documents/trace-2014-12-18.png}}
%%     \end{subfigure}
%%     \rule{\linewidth}{1pt}
...
%%     \centering
%%     \begin{subfigure}
%%       {\includegraphics[width=\textwidth]{documents/trace-2014-12-20.png}}
%%     \end{subfigure}
%%     \rule{\linewidth}{1pt}
...
%%     \centering
%%     \begin{subfigure}
%%       {\includegraphics[width=\textwidth]{documents/trace-2015-01-09.png}}
%%     \end{subfigure}
%%     \rule{\linewidth}{1pt}
...
%% \begin{figure}[htb]
%%   \centering
%%       {\includegraphics[width=\textwidth]{documents/trace-2015-01-15.png}}
%%       \rule{\linewidth}{1pt}
...
%% \begin{figure}[htb]
%%   \centering
%%       {\includegraphics[width=\textwidth]{documents/trace-2015-01-17.png}}
%%       \rule{\linewidth}{1pt}
...
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/trace_bodytrack.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/trace_canneal.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/trace_dedup.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/trace_fluidanimate.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/trace_freqmine.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/trace_swaption.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
  \caption{Trace}
  \label{fig:trace}
\end{figure}
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/result_bodytrack.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/result_canneal.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/result_dedup.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/result_fluidanimate.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/result_freqmine.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{documents/result_swaption.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
  \caption{Result}
  \label{fig:result}
\end{figure}
...
\begin{figure}[htb]
  \centering
  \begin{subfigure}
    {\includegraphics[width=0.4\textwidth]{documents/graph3.png}}
  \end{subfigure}
  \begin{subfigure}
    {\includegraphics[width=0.4\textwidth]{documents/graph4.png}}
  \end{subfigure}
