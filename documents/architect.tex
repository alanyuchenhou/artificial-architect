...
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=\textwidth]{path_length_average_benchmark.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
...
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=\textwidth]{hop_count_average_benchmark}} \end{subfigure}
  \rule{\linewidth}{1pt}
...
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=\textwidth]{link_length_average_benchmark.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
...
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=\textwidth]{latency_benchmark.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
  \caption{latency}
...
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=\textwidth]{energy_benchmark.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
  \caption{energy}
...
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=\textwidth]{latency_energy_product_benchmark.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
