...
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=\textwidth]{average_hop_count}} \end{subfigure}
  \rule{\linewidth}{1pt}
  \caption{average hop count}
  \label{fig:average_hop_count}
\end{figure}
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=\textwidth]{average_path_length.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
  \caption{average path length}
  \label{fig:average_path_length}
\end{figure}
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=\textwidth]{latency.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
  \caption{latency}
  \label{fig:latency}
\end{figure}
