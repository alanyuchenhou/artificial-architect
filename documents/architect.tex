...
%%     \centering
%%     \begin{subfigure}
%%       {\includegraphics[width=\textwidth]{zulu/trace-2014-12-18.png}}
%%     \end{subfigure}
%%     \rule{\linewidth}{1pt}
...
%%     \centering
%%     \begin{subfigure}
%%       {\includegraphics[width=\textwidth]{zulu/trace-2014-12-20.png}}
%%     \end{subfigure}
%%     \rule{\linewidth}{1pt}
...
%%     \centering
%%     \begin{subfigure}
%%       {\includegraphics[width=\textwidth]{zulu/trace-2015-01-09.png}}
%%     \end{subfigure}
%%     \rule{\linewidth}{1pt}
...
%% \begin{figure}[htb]
%%   \centering
%%       {\includegraphics[width=\textwidth]{zulu/trace-2015-01-15.png}}
%%       \rule{\linewidth}{1pt}
...
%% \begin{figure}[htb]
%%   \centering
%%       {\includegraphics[width=\textwidth]{zulu/trace-2015-01-17.png}}
%%       \rule{\linewidth}{1pt}
...
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/trace_bodytrack.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/trace_canneal.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/trace_dedup.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/trace_fluidanimate.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/trace_freqmine.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/trace_swaption.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
  \caption{Trace}
  \label{fig:trace}
\end{figure}
\begin{figure}[htb]
  \centering
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/result_bodytrack.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/result_canneal.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/result_dedup.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/result_fluidanimate.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/result_freqmine.png}} \end{subfigure}
  \begin{subfigure} {\includegraphics[width=.4\textwidth]{zulu/result_swaption.png}} \end{subfigure}
  \rule{\linewidth}{1pt}
  \caption{Result}
  \label{fig:result}
\end{figure}
...
\begin{figure}[htb]
  \centering
  \begin{subfigure}
    {\includegraphics[width=0.4\textwidth]{zulu/graph3.png}}
  \end{subfigure}
  \begin{subfigure}
    {\includegraphics[width=0.4\textwidth]{zulu/graph4.png}}
  \end{subfigure}
